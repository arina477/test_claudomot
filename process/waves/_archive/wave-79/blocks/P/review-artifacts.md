...
| P-1 | process/waves/wave-79/stages/P-1-decompose.md | done | |
| P-2 | process/waves/wave-79/stages/P-2-spec.md | done | |
| P-3 | process/waves/wave-79/stages/P-3-plan.md | done | |
| P-4 | process/waves/wave-79/stages/P-4-gemini-review.md | done | |
...
- **design_gap_flag:** true (E2E status indicator — new trust-signal surface)
