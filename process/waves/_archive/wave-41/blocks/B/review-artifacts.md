...
**Block:** B (Build) · **Wave topic:** M8 educator role + light moderation · **Block exit gate:** B-6 · **Status:** gate-passed
...
| B-6 | stages/B-6-review.md | done | head-builder APPROVED; code-reviewer 2 HIGH fixed (03e1102) |
...
last_commit_sha:       03e1102
ready_for_ci:          true
```
Carries → T-block: verify moderation authz live (rank guard both actions; mute-gate createMessage+createReply; delete-any). Incidental: server-roles.test.tsx flake fixed (task 6832e3ea resolvable at close).
