...
| P-2 | process/waves/wave-36/stages/P-2-spec.md | pending | |
| P-3 | process/waves/wave-36/stages/P-3-plan.md | pending | |
...
- **design_gap_flag:** unset (P-1). Likely FALSE (test-authoring + 1-line stub-date; no new UI).
