...
**Block:** B (Build) | **Wave topic:** M5 assignments (CRUD + per-member status + panel/card UI) | **Gate:** B-6 | **Status:** gate-passed
## Stage deliverables
...
| B-6 | stages/B-6-review.md | done | head-builder APPROVED; /review caught+fixed H1 cross-server attachment IDOR + H2; clean |
## Context
...
cross_server_attachment_idor_closed: true
ready_for_ci: true
medium_to_v2: [client-owner-only-gate]
```
