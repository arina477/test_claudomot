...
| P-1 | stages/P-1-decompose.md | pending | multi-spec |
| P-2 | stages/P-2-spec.md | pending | per-task blocks |
...
- **Roadmap milestone:** M8 (84e17739) in_progress, class=product-feature, H2
- **design_gap_flag:** unset (P-1) — likely TRUE (educator UI surfaces)
- **claimed_task_ids:** [6cf06f99, 6ddddc2d] (multi-spec)
