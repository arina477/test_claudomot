...
- **Gaps inventoried:** member-moderation/timeout UI (1 real gap). Trivial (not gaps): moderate_members role toggle (server-roles pattern), delete-any (MessageList hover-actions).
- **Gaps deferred to bug-design tag:** none
- **3-cap escalations:** none
- **DESIGN-SYSTEM.md token additions proposed:** none expected
