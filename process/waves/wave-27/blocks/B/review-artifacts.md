...
**Block:** B (Build) | **Wave topic:** Presence performance pair (server_members(user_id) index + MessageList single-subscription lift) | **Block exit gate:** B-6 | **Status:** in-progress | **wave_type:** multi-spec | **branch:** wave-27-presence-perf
...
| B-6 | stages/B-6-review.md | pending | head-builder + /review; multi-spec commit discipline (Action 6) |
