...
- **design_gap_flag:** unset — expect FALSE (existing presence-dot primitive + design ref design/server-channel-view.html; message-row avatar surface exists). Confirm at P-1.
