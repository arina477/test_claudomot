...
4. **Re-read** `CLAUDE.md` always-on rules + `command-center/principles/` + `project.yaml`: "Ensure solutions align with project rules + structured facts"
...
4. Re-read `CLAUDE.md` + `command-center/principles/` + `project.yaml` (does it follow project rules + facts?)"
