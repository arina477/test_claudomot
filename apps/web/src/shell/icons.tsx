/**
 * Minimal inline SVG icons — Phosphor-style, stroke-based, 24×24 viewBox.
 * Only the icon shapes required by the B-3 shell are included.
 * Each icon is aria-hidden by default; callers supply accessible labels
 * via the parent button/element.
 */
...
export function ClipboardTextIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PushPinIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SpinnerIcon({ size = 14, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {/* Arc: only the top portion to look like a spinner */}
...
export function WarningCircleIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SealCheckIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M12 2l2.4 3.6 4.1-.5-1.2 4 2.7 3.1-3.8 1.5-.2 4.3-4-1.3-3.2 2.8-.8-4.3-4-1.4 2.6-3.1L5.5 5.1l4.1.5z" />
      <polyline points="9 12 11 14 15 10" />
    </svg>
  );
}

export function EnvelopeIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CrownIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M2 20h20v2H2v-2zm2-2l2-9 4 4 2-7 2 7 4-4 2 9H4z" />
    </svg>
  );
}

export function LockKeyIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CaretRightIcon({ size = 12, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EyeSlashIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UserAddIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PaperPlaneIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChatsCircleIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PencilSimpleIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SmileyIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ProhibitIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PaperclipIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ImageBrokenIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArrowsOutIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DownloadSimpleIcon({ size = 18, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MicrophoneSlashIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SignOutIcon({ size = 18, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArrowCounterClockwiseIcon({ size = 18, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ScreencastIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WifiLowIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      {/* Only the bottom arc — representing low signal */}
      <path d="M12 20h.01" />
...
export function VideoCameraIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MonitorIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Calendar — schedule/session icon (wave-43). */
...
/** Calendar with an X — session not found / empty calendar (wave-43). */
export function CalendarXIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Arrows clockwise — weekly recurrence chip (wave-43). */
export function ArrowsClockwiseIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Three horizontal dots — overflow/kebab menu trigger (wave-41 moderation). */
export function DotsThreeIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Speaker with X — muted/timed-out indicator (wave-41 moderation). Fill variant. */
export function SpeakerXFillIcon({ size = 15, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Speaker high (unmuted) — remove timeout action (wave-41 moderation). */
export function SpeakerHighIcon2({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Compass — Discover public servers navigation icon (wave-67). */
export function CompassIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Phosphor ph-flag — flag icon for report affordances. */
...
/** Phosphor ph-faders — horizontal sliders icon for settings toggles. */
export function FadersIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M40,88H73a32,32,0,0,0,62,0h81a8,8,0,0,0,0-16H135a32,32,0,0,0-62,0H40a8,8,0,0,0,0,16Zm64-24A16,16,0,1,1,88,80,16,16,0,0,1,104,64ZM216,168H183a32,32,0,0,0-62,0H40a8,8,0,0,0,0,16H121a32,32,0,0,0,62,0h33a8,8,0,0,0,0-16Zm-64,24a16,16,0,1,1,16-16A16,16,0,0,1,152,192Z" />
    </svg>
  );
}
