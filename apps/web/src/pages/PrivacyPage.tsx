        ...
        <div className="mt-8 space-y-8 text-base leading-relaxed" style={{ lineHeight: '1.5' }}>
          ...
          <section>
            ...
            <p className="mt-3" style={{ color: 'rgba(255,255,255,0.60)' }}>
              ...
              time by contacting us at the address below. Account deletion removes your profile and
              message history from active systems. Full data-rights tools (export, audit log,
