          ...
          <div className="mt-8 space-y-8 text-base leading-relaxed" style={{ lineHeight: '1.5' }}>
            ...
            <section>
              ...
              <p className="mt-3" style={{ color: 'rgba(255,255,255,0.60)' }}>
                ...
                use StudyHall to distribute spam, malware, or illegal content, or to harass, bully,
                or harm other users.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3" style={{ color: 'rgba(255,255,255,0.60)' }}>
                ...
                terminate accounts that violate these terms, with or without prior notice, at our
                sole discretion.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3" style={{ color: 'rgba(255,255,255,0.60)' }}>
                StudyHall is provided &ldquo;as is&rdquo; without warranty of any kind. To the
                maximum extent permitted by law, StudyHall Inc. is not liable for any indirect,
            ...
            >
              This is a stub terms document for the self-use MVP stage. Full terms covering
              moderation policy, educator-tier terms, and paid-tier billing will be published before
              any external or paying users are onboarded.
            </p>
          </div>
        </main>
