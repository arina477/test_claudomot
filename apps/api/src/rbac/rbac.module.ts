...
import { MemberRoleController, RbacController, ServerPermissionsController } from './rbac.controller';
import { RbacService } from './rbac.service';

@Module({
  imports: [AuthModule],
  controllers: [RbacController, MemberRoleController, ServerPermissionsController, ChannelOverrideController],
