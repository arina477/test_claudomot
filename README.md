...
Accounts are live: sign up, log in, verify email, reset password, and customize your profile — display name, unique @username, and accent color — through the app. You can also create a study server — it starts with a #general channel — and see it in the server rail with its channels in the sidebar.
