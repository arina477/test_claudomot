# T-9 Journey Principles — <Your Project>

Cross-wave rules specific to **T-9 (user-journey-map regen + scenario smoke)**. Append-only; numbered sequentially. Read at every T-9 stage.
