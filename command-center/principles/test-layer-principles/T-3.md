# T-3 Contract Principles — <Your Project>

Cross-wave rules specific to **T-3 (API/SDK contract tests)**. Append-only; numbered sequentially. Read at every T-3 stage.
