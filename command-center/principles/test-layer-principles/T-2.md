# T-2 Unit Principles — <Your Project>

Cross-wave rules specific to **T-2 (pure-function + module tests)**. Append-only; numbered sequentially. Read at every T-2 stage.
