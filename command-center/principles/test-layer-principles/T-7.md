# T-7 Perf Principles — <Your Project>

Cross-wave rules specific to **T-7 (Core Web Vitals, bundle size, regression baselines)**. Append-only; numbered sequentially. Read at every T-7 stage.
