# T-6 Layout Principles — <Your Project>

Cross-wave rules specific to **T-6 (Figma diff / visual regression)**. Append-only; numbered sequentially. Read at every T-6 stage.
