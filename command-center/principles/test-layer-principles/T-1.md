# T-1 Static Principles — <Your Project>

Cross-wave rules specific to **T-1 Static** (typecheck + lint). Append-only; numbered sequentially. Read at every T-1 stage.
